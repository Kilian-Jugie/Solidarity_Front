              ...
              <div className="container">
                <div className="carousel-caption text-center">
                  ...
                  <p>
                    ...
                    Le projet COOP est un de nos partenaire nous permettant d'ouvrir le fablab de bordeaux à toute personne ayant besoin de tels outils.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container marketing">
          ...
          <div className="row featurette">
            <div className="col-md-7">
              ...
              <p className="lead">
                Voici un exemple de visère confectionné par le CESI.
